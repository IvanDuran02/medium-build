        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 m-y-10 max-w-2xl mx-auto mb-10">
          ...
          <label className="block mb-5 ">
            ...
            <input
              ...
              className="shadow border rounded py-2 px-4 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring-1"
          ...
          <label className="block mb-5 ">
            ...
            <textarea
              ...
              className="shadow border rouned py-2 px-3 form-textarea mt-1 block w-full ring-yellow-500 outline-none focus:ring-1 "
              placeholder="John Appleseed"
              rows={8}
            />
          </label>
          ...
          <input
            className="shadow bg-yellow-500 hover:bg-yellow-400 focus:shadow-outline focus:outline-none text-white py-2 px-4 rounded cursor-pointer font-bold"
            type="submit"
          />
        </form>
      )}
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, // after 600 seconds, it'll update the old cached version
  };
};
